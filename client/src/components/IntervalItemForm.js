...
function IntervalItemForm({dateToString, workoutType}) {
    ...
    const [intervalInputFields, setIntervalInputFields] = useState([
        {qty: "", description: "", interval_unit: "meters", pace: "", rest_unit: "", rest: ""}
    ])
    ...
    function handleAddRepClick(e) {
        e.preventDefault()
        let newField = {qty: "", description: "", interval_unit: "meters", pace: "", rest_unit: "", rest: ""}
                ...
                {intervalInputFields.map((input, index) => {
                        return (
                            <div key={index} className="interval_form_entry">
                                <input id="qty_input" className="interval_form_entry_item" name="qty" placeholder="1" type="number" value={input.qty} onChange={(e) => handleFormDataChange(index, e)}/>
                                <p> x </p>
                                <input className="interval_form_entry_item" name="description" type="number" placeholder="distance" value={input.description} onChange={(e) => handleFormDataChange(index, e)}/>
                                <select className="interval_form_entry_item" name="interval_unit" onChange={(e) => handleFormDataChange(index, e)}>
                                    <option value="meters">meters</option>
                                    <option value="miles">miles</option>
                                    <option value="minutes">minutes</option>
                                </select>
                                <p className="interval_form_entry_item"> @ </p>
                                <input className="interval_form_entry_item" name="pace" placeholder="pace" value={input.pace} onChange={(e) => handleFormDataChange(index, e)}/>
                                <p className="interval_form_entry_item"> with </p>
                                <input className="interval_form_entry_item" name="rest" placeholder="rest duration" value={input.rest} onChange={(e) => handleFormDataChange(index, e)}/>
                                <select className="interval_form_entry_item" name="rest_unit" onChange={(e) => handleFormDataChange(index, e)}>
                                    <option value="meters">meters</option>
                                    <option value="minutes">minutes</option>
                                </select>
